...
public class HelloServiceLocator extends org.apache.axis.client.Service implements webservices.HelloService {
    ...
    private java.lang.String HelloPort_address = "http://localhost:8080/fakeDBWeb/HelloService";
    ...
    public webservices.Hello_PortType getHelloPort() throws javax.xml.rpc.ServiceException {
    ...
    public webservices.Hello_PortType getHelloPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            webservices.HelloPortBindingStub _stub = new webservices.HelloPortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (webservices.Hello_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                webservices.HelloPortBindingStub _stub = new webservices.HelloPortBindingStub(new java.net.URL(HelloPort_address), this);
                _stub.setPortName(getHelloPortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://webservices/", "HelloService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://webservices/", "HelloPort"));
        }
